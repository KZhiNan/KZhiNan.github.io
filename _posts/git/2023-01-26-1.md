	...
	<ul>
	    <li>
	        <div id="index1">
				...
				<img src="/assets/media/git/1/down.jpg" alt="namuwiki reference" width="100%" height="100%">
				</a>
	            <p>
	        ...
	        <div id="index3">
	            ...
	            <ol>
	                ...
	                <li>
	                    ...
	                    <img src="/assets/media/git/1/image2.jpg" alt="CVCS image" width="100%" height="100%">
	                    <p>
	                    ...
	                    <ul>
	                        <li>
	                            ...
	                            <img src="/assets/media/git/1/image3.jpg" alt="CVCS problem" width="100%" height="100%">
	                            <p>
	                ...
	                <li>
	                    ...
	                    <img src="/assets/media/git/1/image4.jpg" alt="DVCS image" width="100%" height="100%">
	                    <p>
	    ...
	    <li>
	        <div id="index5">
	            ...
	            <img src="/assets/media/git/1/image5.jpg" alt="Git working flow" width="100%" height="100%">
	        </div>
	    </li>
	</ul>
	<br />
