	...
	<ul>
	    <li>
	        <div id="index1">
	            ...
	            <img src="/assets/media/git/2/img1.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
	            <p>
	                다음으로 컴퓨터 운영체제의 환경에 맞는 Setup 파일을 다운로드 하면 된다. 본인은 Windows 64bit를 다운 받았다. 
	            </p>
				<img src="/assets/media/git/2/img2.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
				...
				<img src="/assets/media/git/2/img3.jpg" alt="img" width="100%" height="100%">
				<img src="/assets/media/git/2/img4.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
	                Setup을 다운로드 완료했다면 실행시켜 주고, 처음 화면에서는 Next를 눌러준다. 
	            </p>
				<img src="/assets/media/git/2/img5.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
	                Git이 설치될 디렉토리를 설정해주는 화면인데 본인은 하드디스크 D에 설치하였기에 수정을 하였고, 특별히 요구사항이 없다면 그냥 Next버튼을 눌러주면 된다. 
	            </p>
				<img src="/assets/media/git/2/img6.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
	                기본설정 상태로 Next를 눌러주면 된다. 
	            </p>
				<img src="/assets/media/git/2/img7.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
	                시작메뉴에 Git을 추가할건지 묻는것인데 그냥 Next를 클릭해준다. 
	            </p>
				<img src="/assets/media/git/2/img8.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
	                다음으로 default editor를 설정하는 화면인데 본인이 Git을 사용할 때 사용할 기본 프로그램을 선택하고 Next를 눌러주면 된다. 
	            </p>
				<img src="/assets/media/git/2/img9.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
	                Let Git decide를 선택하고 Next를 눌러준다. 
	            </p>
				<img src="/assets/media/git/2/img10.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
	                다음으로 Git from the command line and also from 3rd-party software를 선택하고 Next를 누른다.
	            </p>
				<img src="/assets/media/git/2/img11.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
	                Use Bundled OpenSSH를 선택하고 Next버튼을 누른다. 
	            </p>
				<img src="/assets/media/git/2/img12.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
	                Use the OpenSSL library를 클릭하고 Next를 누른다. 
	            </p>
				<img src="/assets/media/git/2/img13.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
	                Checkout Windows-style, commit Unix-style line endings를 선택하고 Next를 누른다. 
	            </p>
				<img src="/assets/media/git/2/img14.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
	                Use MinTTY(the default terminal of MSYS2)를 선택하고 Next를 누른다.
	            </p>
				<img src="/assets/media/git/2/img15.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
	                Default(fast-forward or merge)를 선택하고 Next를 누른다. 
	            </p>
				<img src="/assets/media/git/2/img16.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
	                Git Credential Manager를 선택하고 Next를 누른다. 
	            </p>
				<img src="/assets/media/git/2/img17.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
	            	Enable file system caching를 선택하고 Next를 누르면 이제 설치가 진행될 것이다. 
	            </p>
				<img src="/assets/media/git/2/img18.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
	                설치가 완료되면 다음과 같이 Completing the Git Setup Wizard라는 말이 나올것이다. 
	            </p>
				<img src="/assets/media/git/2/img19.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />	
				<p>
					설치가 완료된 후 시작메뉴에 Git폴더가 추가된 것을 볼 수 있다. Git 프로그램 항목에 대해 간단히 소개를 하자면 다음과 같다. 
	            </p>
				<img src="/assets/media/git/2/img20.jpg" alt="img" width="100%" height="100%">
				<p>
				...
				<br />	
				<img src="/assets/media/git/2/img21.jpg" alt="img" width="100%" height="100%">
				<p>
...
{% endhighlight %}
				...
				<img src="/assets/media/git/2/img22.jpg" alt="img" width="100%" height="100%">
				<p>
				...
				<img src="/assets/media/git/2/img23.jpg" alt="img" width="100%" height="100%">
				<br />
				<br />
{% highlight ruby %}
# 시스템 설정 내용 
...
{% endhighlight %}
				<img src="/assets/media/git/2/img24-1.jpg" alt="img" width="100%" height="100%">
				<img src="/assets/media/git/2/img24-2.jpg" alt="img" width="100%" height="100%">
				<br />
				<br />
{% highlight ruby %}
# 현재 사용자 환경 설정 내용
...
{% endhighlight %}
				<img src="/assets/media/git/2/img25-1.jpg" alt="img" width="100%" height="100%">
				<img src="/assets/media/git/2/img25-2.jpg" alt="img" width="100%" height="100%">
	        </div>
	    </li>
	    <hr class="hr-line2"/>
	    <li>
	        <div id="index3">
				...
				<ol>
					<li>
						...
						<img src="/assets/media/git/2/img26.jpg" alt="img" width="100%" height="100%">
						<img src="/assets/media/git/2/img27.jpg" alt="img" width="100%" height="100%">
					</li>
					<li>
						<p><code>pwd</code> : 현재 위치하고 있는 디렉토리의 전체 경로 출력.</p>
						<img src="/assets/media/git/2/img28.jpg" alt="img" width="100%" height="100%">
					</li>
					<li>
						<p>
							<code>ls(ll)</code> : ls는 해당 디렉토리에 존재하는 파일과 폴더를 나타내 주며, ll을 입력하면 권한과 시간등 파일과 디렉토리에 대한 상세 정보가 나온다.
						</p>
						<img src="/assets/media/git/2/img29.jpg" alt="img" width="100%" height="100%">
					</li>
					<li>
						<p>
							<code>touch</code> : 새로운 파일을 생성하거나, 해당 파일의 타임스탬프를 변경하는 용도로 사용한다.
						</p>
						<img src="/assets/media/git/2/img30.jpg" alt="img" width="100%" height="100%">
					</li>
					<li>
						<p>
							<code>rm</code> :  현재 디렉토리에 존재하는 파일을 삭제하는 명령어.
						</p>
						<img src="/assets/media/git/2/img31.jpg" alt="img" width="100%" height="100%">
					</li>
					<li>
						<p>
							<code>mkdir</code> :  현재 디렉토리에 새로운 폴더 생성.
						</p>
						<img src="/assets/media/git/2/img32.jpg" alt="img" width="100%" height="100%">
					</li>
					<li>
						<p>
						...
						<img src="/assets/media/git/2/img33.jpg" alt="img" width="100%" height="100%">
					</li>
					<li>
						<p>
							<code>mv</code> : mv + 파일명 + 디렉토리명 입력을 통해 해당 파일을 입력한 디렉토리로 이동시킨다. 
						</p>
						<img src="/assets/media/git/2/img34.jpg" alt="img" width="100%" height="100%">
					</li>
					<li>
						<p>
