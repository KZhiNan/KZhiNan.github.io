	...
	<ul>
	    <li>
	        <div id="index1">
                ...
                <img src="/assets/media/git/3/img1.jpg" alt="img" width="100%" height="100%">
				<br />	
				<br />
	            <p>
	                동의를 선택하고 다음 버튼을 누른다. 
	            </p>
                <img src="/assets/media/git/3/img2.jpg" alt="img" width="100%" height="100%">
                <br />	
				<br />
                <p>
	                설치할 디렉토리를 설정하고 다음 버튼을 누른다. 
	            </p>
                <img src="/assets/media/git/3/img3.jpg" alt="img" width="100%" height="100%">
                <br />	
				<br />
                <p>
	                시작 메뉴 폴더를 만들지 물어보는데 그냥 다음 버튼을 누르자. 
	            </p>
                <img src="/assets/media/git/3/img4.jpg" alt="img" width="100%" height="100%">
                <br />	
				<br />
                <p>
	                필요한 항목이 있다면 추가로 선택하고 다음 버튼을 눌러서 설치를 완료하자.
	            </p>
                <img src="/assets/media/git/3/img5.jpg" alt="img" width="100%" height="100%">
                <img src="/assets/media/git/3/img6.jpg" alt="img" width="100%" height="100%">
                <br />	
				<br />
	        </div>
	    </li>
	    ...
	    <li>
	        <div id="index2">
                ...
                <ol>
					...
					<img src="/assets/media/git/3/img7.jpg" alt="img" width="100%" height="100%">
					<img src="/assets/media/git/3/img8.jpg" alt="img" width="100%" height="100%">
                	<br />	
					<br />
					<p>
						상단메뉴에서 <span style="color:red">Terminal->New Terminal</span>을 클릭한다.
					</p>
					<img src="/assets/media/git/3/img9.jpg" alt="img" width="100%" height="100%">
                	<br />	
					<br />
					<p>
					...
					<img src="/assets/media/git/3/img10.jpg" alt="img" width="100%" height="100%">
                	<br />	
					<br />
					<p>
					...
					<img src="/assets/media/git/3/img11.jpg" alt="img" width="100%" height="100%">
                	<br />
					<p>
...
{% endhighlight %}	
					...
					<img src="/assets/media/git/3/img12.jpg" alt="img" width="100%" height="100%">
                	<br />		
					<p>
...
{% endhighlight %}	
					<img src="/assets/media/git/3/img13.jpg" alt="img" width="100%" height="100%">
{% highlight ruby %}
git commit -m “Reversion.0” -m “add code” 
{% endhighlight %}	
					<img src="/assets/media/git/3/img14.jpg" alt="img" width="100%" height="100%">
					<br />		
					<br />		
					<p>
						이제 Git저장소 만드는 작업을 완료했으니 원격 저장소인 GitHub와 연동을 시켜보자. GitHub를 회원가입 후 상단 오른쪽 메뉴 중 New repository를 클릭해 GitHub내에 새로운 원격 저장소를 만든다. 
					</p>
					<img src="/assets/media/git/3/img15.jpg" alt="img" width="100%" height="100%">
					<br />		
					<br />		
					<p>
					...
					<img src="/assets/media/git/3/img16.jpg" alt="img" width="100%" height="100%">
					<br />		
					<br />		
					<p>
					...
					<img src="/assets/media/git/3/img17.jpg" alt="img" width="100%" height="100%">
					<img src="/assets/media/git/3/img18.jpg" alt="img" width="100%" height="100%">
					<br />		
					<br />		
					<p>
						다음으로 <code>git push origin master</code>를 입력하면 GitHub저장소에 로컬 디렉토리 프로젝트의 파일들이 추가 된 것을 볼수있다. 
					</p>
					<img src="/assets/media/git/3/img19.jpg" alt="img" width="100%" height="100%">
					<img src="/assets/media/git/3/img20.jpg" alt="img" width="100%" height="100%">
					<br />		
					<br />
					...
					<img src="/assets/media/git/3/img21.jpg" alt="img" width="100%" height="100%">
					<br />		
					<br />
					<p>
					...
					<img src="/assets/media/git/3/img22.jpg" alt="img" width="100%" height="100%">
					<img src="/assets/media/git/3/img23.jpg" alt="img" width="100%" height="100%">
					<br />		
					<br />
                </ol>
	        </div>
	    ...
	    <li>
	        <div id="index3">
				...
				<img src="/assets/media/git/3/img25.jpg" alt="img" width="100%" height="100%">
				<br />		
				<br />
				<p>
...
git status
{% endhighlight %}	
					<img src="/assets/media/git/3/img26.jpg" alt="img" width="100%" height="100%">
					<br />
					<br />
{% highlight ruby %}
git status index.html
{% endhighlight %}	
					<img src="/assets/media/git/3/img27.jpg" alt="img" width="100%" height="100%">				
	        </div>
	    </li>
	</ul>
	<br />
